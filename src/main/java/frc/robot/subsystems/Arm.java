...
public class Arm extends SubsystemBase {
  ...
  public Arm() {
    ...
    extensionSolenoid = new Solenoid(PneumaticChannels.PCMId, PneumaticsModuleType.CTREPCM, 3);
    gripSolenoid = new Solenoid(PneumaticChannels.PCMId, PneumaticsModuleType.CTREPCM, 4);
    pincerSolenoid = new Solenoid(PneumaticChannels.PCMId, PneumaticsModuleType.CTREPCM, 2);
