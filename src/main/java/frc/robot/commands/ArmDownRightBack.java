...
public class ArmDownRightBack extends SequentialCommandGroup {
  /** Creates a new AutoTesting. */
  public ArmDownRightBack(DriveSubsystem drive, Arm arm, Vacuum vacuum) {
    ...
    addCommands(
        ...
        new FollowTrajectory(drive, AutoTrajectories.exitZoneLessRight, true)
